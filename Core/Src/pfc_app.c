                                           ...
                                           size_t value_size)
{
  ...
  PFC_FormatFixed(value, value_size, pfc_vac_fast_v, 1U);
  PFC_FormatFixed(value2, sizeof(value2), pfc_vin_shape, 2U);
  (void)snprintf(line, line_size, "VA:%s VS:%s", value, value2);
  PFC_OLED_WriteLine(3U, line);
